...
import com.onlineicttutor.child_monitor.db.DBAdapterSeven;
import com.onlineicttutor.child_monitor.model.Question;

import java.util.ArrayList;
import java.util.List;

public class SevenConceptActivity extends AppCompatActivity {
   ...
   private Question currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapterSeven dbAdapter=new DBAdapterSeven(this);
        questionsList= dbAdapter.getSevenQuestions();
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(SevenConceptActivity.this, ResultActivity.class);
