...
public class ZeroConceptActivity extends AppCompatActivity {
...
//                    add for loop to check each question individually
...
//                        questionsList.add(new Question());
                        ...
                        if (answer != null) {
                            ...
                            if (questionId < dbAdapter.rowCount()) {
                                ...
                                Intent intent = new Intent(ZeroConceptActivity.this, ResultActivity.class);
