...
//                zeromonthsdialog();
                startActivity(new Intent(ChildMonitorQuiz.this, ZeroActivity.class));
            }
        });
        ...
        fivemonths.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                fivemonthsdialog();
                startActivity(new Intent(ChildMonitorQuiz.this, FiveActivity.class));
            }
        });
        ...
        twelvemonths.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                twelvemonthsdialog();
                startActivity(new Intent(ChildMonitorQuiz.this, TwelveActivity.class));
            }
        });
        ...
        twoyears.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                twoyearsdialog();
                startActivity(new Intent(ChildMonitorQuiz.this, TwoActivity.class));
            }
        });
...
//                threehalfyearsyearsdialog();
                startActivity(new Intent(ChildMonitorQuiz.this, ThreeActivity.class));
            }
        });
